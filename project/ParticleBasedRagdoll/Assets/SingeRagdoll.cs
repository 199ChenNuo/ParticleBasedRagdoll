...
public class SingeRagdoll : MonoBehaviour
{
    ...
    BallJoint neck_to_chest;
    BallJoint chest_to_hip;
    BallJoint left_hip_to_thigh;
    BallJoint right_hip_to_thigh;
    ...
    BallJoint left_chest_to_overarm;
    BallJoint right_chest_to_overarm;
    ...
    void Start()
    {
        ...
        left_thigh_to_underleg.init(left_thigh, left_underleg, p15, p16, 45, 45);
        left_underleg_to_feet = new MyHingeJoint();
        left_underleg_to_feet.init(left_underleg, left_feet, p19, p20, 90, 0);
        right_hip_to_thigh = new BallJoint();
        right_hip_to_thigh.init(hip, right_thigh, p12, p14, 90, new Vector3(0, 0, 1));
        right_thigh_to_underleg = new MyHingeJoint();
        right_thigh_to_underleg.init(right_thigh, right_underleg, p17, p18, 45, 45);
        right_underleg_to_feet = new MyHingeJoint();
        right_underleg_to_feet.init(right_underleg, right_feet, p21, p22, 90, 0);
        left_chest_to_overarm = new BallJoint();
        left_chest_to_overarm.init(chest, left_overarm, p8, p27, 90, new Vector3(-1, 0, 0));
        left_overarm_to_underarm = new MyHingeJoint();
        left_overarm_to_underarm.init(left_overarm, left_underarm, p28, p29, 180, 0);
        left_arm_to_hand = new MyHingeJoint();
        left_arm_to_hand.init(left_underarm, left_hand, p30, p31, 90, 90);
        right_chest_to_overarm = new BallJoint();
        right_chest_to_overarm.init(chest, right_overarm, p9, p34, 90, new Vector3(1, 0, 0));
        ...
        ragdoll.add_constraint(chest_to_hip);
        ragdoll.add_constraint(left_hip_to_thigh);
        ragdoll.add_constraint(left_thigh_to_underleg);
        ragdoll.add_constraint(left_underleg_to_feet);
        ragdoll.add_constraint(right_hip_to_thigh);
        ragdoll.add_constraint(right_thigh_to_underleg);
        ragdoll.add_constraint(right_underleg_to_feet);
        ragdoll.add_constraint(left_chest_to_overarm);
        ragdoll.add_constraint(left_overarm_to_underarm);
        ragdoll.add_constraint(left_arm_to_hand);
