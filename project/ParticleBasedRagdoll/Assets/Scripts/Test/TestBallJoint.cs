...
public class TestBallJoint : MonoBehaviour
{
    public Particle A1;
    public Particle A2;
    public Particle A3;
    ...
    void Start()
    {
        ...
        A2.set_position(new Vector3(2, 2, 0));
        A2.set_init_position(new Vector3(2, 2, 0));
        A3.set_position(new Vector3(2, -2, -1));
        A3.set_init_position(new Vector3(2, -2, -1));
        // The shared particle
        A4.set_position(new Vector3(0, 4, 0));
        A4.set_init_position(new Vector3(0, 4, 0));
        ...
        B3.set_position(new Vector3(0, 8, 0));
        B3.set_init_position(new Vector3(0, 8, 0));
        ...
        ball.init(boneA, boneB, A4, B3, 30, new Vector3(0, 1, 0));
